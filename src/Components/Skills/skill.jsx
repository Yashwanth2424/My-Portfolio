      ...
      <div className="Peoject-section-inner-container">
        ...
        <div className="social-section">
          <div className="social-links">
            <a href="https://www.linkedin.com/in/thalka-yashwanth-12b57b28b/" target="_blank" rel="noopener noreferrer" className="social-icon">
              <FaLinkedin /> LinkedIn
            </a>
            <a href="https://github.com/Yashwanth2424" target="_blank" rel="noopener noreferrer" className="social-icon">
              <FaGithub /> GitHub
            </a>
          </div>
        </div>
...
<h2 className="Project-inner-container-heading">Connect With Me</h2>
<div className="social-links">
  <a href="https://github.com/yourusername" target="_blank" rel="noopener noreferrer" className="social-link">
    <svg xmlns="http://www.w3.org/2000/svg" fill="#1BAE70" viewBox="0 0 496 512" className="social-icon">
  ...
  <a href="https://linkedin.com/in/yourusername" target="_blank" rel="noopener noreferrer" className="social-link">
    <svg xmlns="http://www.w3.org/2000/svg" fill="#1BAE70" viewBox="0 0 448 512" className="social-icon">
...
//                 <div className="progress" style={{ width: `${skill.value}%` }}></div>
//               </div>
//             </div>
//           ))}
//         </div>
//         <div className="social-links">
//           <a href="https://www.linkedin.com/in/YOUR_LINKEDIN" target="_blank" rel="noopener noreferrer" className="social-icon">
//             <FaLinkedin />
//           </a>
//           <a href="https://github.com/YOUR_GITHUB" target="_blank" rel="noopener noreferrer" className="social-icon">
//             <FaGithub />
//           </a>
//         </div>
//       </div>
...
//           <li>Programming Foundations with Python - NXTWave</li>
//           <li>Build Your Own Dynamic Web Application - NXTWave</li>
//           <li>JIGNASA State Level Study Project 2022-23</li>
//           <li>JIGNASA State Level Study Project 2023-24</li>
//         </ul>
//       </div>
//     </section>
//   );
